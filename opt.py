...
parser = argparse.ArgumentParser(description='CDFG', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('--eta_value', type=int, default=0.5)
...
parser.add_argument('--lr_cora', type=float, default=1e-4)
parser.add_argument('--lr_wiki', type=float, default=1e-4)
parser.add_argument('--lr_pubmed', type=float, default=1e-4)
...
parser.add_argument('--gae_n_enc_3', type=int, default=512)
parser.add_argument('--gae_n_enc_4', type=int, default=20)
parser.add_argument('--gae_n_enc_5', type=int, default=20)
